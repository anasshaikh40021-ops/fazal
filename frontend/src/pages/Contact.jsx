    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>54709 Willms Station <br/> Suite 350, Washington America</p>
          <p className='text-gray-500'>Tel: (412) 444-7585 <br/> Email: admin@forever.com</p>
